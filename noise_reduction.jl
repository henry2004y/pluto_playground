...
let
	fig = Figure(size = (600, 200), fontsize=18)
...
let
	...
	lines!(ax, t, y_highpass)
	lines!(ax, t, y, linestyle=:dashdot, color=:black, alpha=0.3)
...
let
	...
	fig = Figure(size = (650, 400), fontsize=18)
	...
	lines!(ax, t, ȳ3, label="nbox = 3")
	lines!(ax, t, ȳ5, label="nbox = 5")
	lines!(ax, t, ȳ10, label="nbox = 10")
	
	lines!(ax, t, y, linestyle=:dashdot, color=:black, alpha=0.3, label="raw")
...
let
	...
	fig = Figure(size = (650, 400), fontsize=18)
   	...
   	ax = Axis(fig[1, 1],
       title = "Neighbor Average Filtered Signal",
       xlabel = "Samples",
       ylabel = "Outputs",
       )
	lines!(ax, t, ȳ1, label="nIter = 1")
	lines!(ax, t, ȳ10, label="nIter = 10")
	lines!(ax, t, ȳ20, label="nIter = 20")
...
manifest_format = "2.0"
project_hash = "9da17f1fd1681acd8ce00dc97201bcbfcc9f4125"
